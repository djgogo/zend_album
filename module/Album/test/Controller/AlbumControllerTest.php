...
class AlbumControllerTest extends AbstractHttpControllerTestCase
{
    ...
    public function setUp()
    {
        ...
        // remove the db configuration for testing and create a mock for the AlbumTable instead with Prophecy
    ...
    {
        // test that AlbumTable's fetchAll() method will be called, and return an array - not working because fetchAll returns paginator object in my case!
